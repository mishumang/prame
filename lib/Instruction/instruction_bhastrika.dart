...
class BhrastrikaBreadthingPage extends StatefulWidget {
  const BhrastrikaBreadthingPage({super.key});

  @override
  State<BhrastrikaBreadthingPage> createState() => _BhrastrikaBreadthingPageState();
}

class _BhrastrikaBreadthingPageState extends State<BhrastrikaBreadthingPage> {
  // Configuration state
  String _selectedTechnique = 'beginner';
  ...
  static const _techniques = [
    {'value': 'beginner', 'label': 'Beginner', 'inhale': 4, 'exhale': 2, 'description': 'Slower pace for learning'},
    {'value': 'advanced', 'label': 'Advanced', 'inhale': 2, 'exhale': 2, 'description': 'Traditional rapid pace'},
    {'value': 'custom', 'label': 'Custom', 'inhale': 0, 'exhale': 0, 'description': 'Set your own timing'},
  ];

  static const _durationOptions = [1, 3, 5, 10, 15, 20, 30, 45, 60];

  // Practice instruction steps for Bhastrika
  static const _instructionSteps = [
    "Sit comfortably in a cross-legged position with your spine straight and shoulders relaxed.",
    "Place your hands on your knees with palms facing upward, or use chin mudra (thumb and index finger touching).",
    "Close your eyes and take 3-4 natural breaths to center yourself.",
    "Begin with forceful, rhythmic breathing through your nose - both inhalation and exhalation should be strong and audible.",
    "For beginners: Inhale for 4 seconds, exhale for 2 seconds. For advanced: Both inhale and exhale for 2 seconds.",
    "Keep your mouth closed throughout the practice and use only nasal breathing.",
    "Start with 3 rounds of 10-15 breaths each, with 30-60 seconds of normal breathing between rounds.",
    "After completing all rounds, sit quietly and observe the sensations in your body.",
  ];
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        Text(
          'Prepare Your Bhastrika Session',
        ...
        Text(
          'Choose your breathing pace and customize your bellows breath experience',
  ...
  Widget _buildTechniqueSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle('BREATHING PACE'),
  ...
  Widget _buildTechniqueOption(Map<String, dynamic> technique) {
    ...
    final bool isBeginner = technique['value'] == 'beginner';
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(
                  technique['value'] == 'beginner'
                      ? Icons.school
                      : technique['value'] == 'advanced'
                      ? Icons.flash_on
                      : Icons.tune,
                  color: Colors.white,
                  size: 24,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (technique['value'] != 'custom')
                      Text(
                        'Inhale: ${technique['inhale']}s • Exhale: ${technique['exhale']}s',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(
                        color: isSelected ? Colors.blue[500] : Colors.blueGrey[500],
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildAboutSection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          "Bhastrika, known as 'Bellows Breath', is a powerful yogic breathing technique that mimics the rapid pumping of bellows used by blacksmiths. This energizing practice involves forceful, rhythmic inhalations and exhalations through the nose, creating internal heat and stimulating the nervous system. Bhastrika helps clear energy channels (nadis), increases oxygen flow, boosts mental clarity, and enhances overall vitality. Regular practice can improve lung capacity, strengthen the respiratory system, and prepare the mind for deeper meditation.",
          style: TextStyle(
              fontSize: 15,
              height: 1.5,
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  "Note: Avoid practicing Bhastrika if you have high blood pressure, heart conditions, or respiratory issues. Start slowly and stop if you feel dizzy.",
                  style: TextStyle(
                    fontSize: 13,
  ...
  Widget _buildPracticeGuide() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionTitle('HOW TO PRACTICE BHASTRIKA'),
        const SizedBox(height: 12),
