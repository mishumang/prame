...
import 'package:meditation_app/api_service.dart'; // Added for fetchUserProfile
...
class _MeditationProfileState extends State<MeditationProfile> {
  ...
  void initState() {
    super.initState();
    _loadUserData(); // Use the same logic as RelaxScreen
  }
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      if (userId != null) {
        // Fetch user profile using api_service.dart
      ...
      setState(() {
        userName = "User Name"; // Fallback in case of error
        _isLoading = false;
      });
    }
  }
  ...
  Future<void> _logout() async {
    ...
    await prefs.remove('userName'); // Clear for consistency
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(
                ...
                children: [
                  Image.asset(
                    'assets/images/yoga_banner.jpeg',
                    fit: BoxFit.cover,
          ...
          Container(
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/yoga_history.jpeg',
                        height: 100,
                        width: 100,
                        fit: BoxFit.cover,
                        errorBuilder: (context, error, stackTrace) {
                ...
                SizedBox(height: 16),
                Image.asset(
                  'assets/images/yoga_centre.jpeg',
                  height: 180,
                  width: double.infinity,
                  fit: BoxFit.cover,
                  errorBuilder: (context, error, stackTrace) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Image.asset(
            title == 'SURYA Program'
                ? 'assets/images/yoga_students.jpeg'
      ...
      child: Column(
        children: [
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(8),
            child: Image.asset(
              'assets/images/founder_teaching.jpeg',
              height: 180,
              width: double.infinity,
              fit: BoxFit.cover,
              errorBuilder: (context, error, stackTrace) {
            ...
            child: Column(
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: Image.asset(
                    'assets/images/yoga_building.jpeg',
                    height: 180,
                    width: double.infinity,
                    fit: BoxFit.cover,
                    errorBuilder: (context, error, stackTrace) {
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            leading: Icon(Icons.spa, color: const Color(0xffA8DADC)),
